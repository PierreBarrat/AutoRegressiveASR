...
# ╔═╡ 8e22586c-8738-4c16-a843-2537f38af969
let
	d = Binomial(1, p1)
	1 - cdf(d, 1/4)
end

# ╔═╡ 1ac3991a-c303-42fb-a2c0-3a66f5d724ba
function α(p, M)
	D = Binomial(M, p)
	Nmin = isodd(M) ? floor(M/2) : M/2
	1 - cdf(D, Nmin)
end

# ╔═╡ 25a2af32-9c2c-4934-a23c-e14008316915
.4^2*.6^1*3

# ╔═╡ 0e87bca5-0c09-46c7-9b80-a5c52dcd9bbe
let
	p = .6
	M = 101
	D = Binomial(M, p)
	Nmin = isodd(M) ? floor(M/2) : M/2 - .1
	@info Nmin
	1 - cdf(D, Nmin)
end

# ╔═╡ a1d6024d-6c11-4405-a24e-f275707fd910
α(.6, 1)
