...
\begin{figure}
	...
	\caption{
		...
		The \emph{consensus} method simply estimates the root of the tree using the consensus of the aligned leaf sequences. 
		\textbf{Left.} Non normalized Hamming distance to the wild-type PSE1 sequence as a function of the number of sequences $M$ used for reconstruction. The fact that the consensus method has a local minimum is discussed in the \SI.
