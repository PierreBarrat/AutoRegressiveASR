...
We investigate the case of the autoregressive evolver. 
...
\figref{fig:fig:hamming_real_arnet} shows the Hamming distance as a function of the node depth, that is the distance separating the node from the leaves. 
