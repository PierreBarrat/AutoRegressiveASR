...
The generative nature of our model allows for sampling of artificial sequences that in principle remain functional, despite being distant from any naturally occurring proteins. 
...
Moreover, the generative algorithm we designed, allows us to go beyond the maximum-likelihood paradigm on which most ASR computational strategies are based on, giving us access to the full posterior distribution of sequences at each internal node. 
