...
Our model not only preserves the generative capacity over long-term evolution but also enables the use of classical phylogenetic techniques such as Felsenstein’s pruning algorithm, which has been a key tool in traditional sequence evolution studies. 
...
Using the generative nature of our model we can perform Bayesian sampling of sequences at internal nodes that should in principle remain functional despite being distant from any naturally occuring protein.
...
We ourselves observe these biases in our simulations, in the form of a convergence to the consensus sequence and an unnaturaly high likelihood according to the generative model. 
...
\subsection*{Acknowledgements} We thank Juan Rodriguez-Rivas for useful discussions. 